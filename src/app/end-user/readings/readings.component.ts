...
export class ReadingsComponent implements OnInit, OnDestroy {
  ...
  addMedia() {
    let mockResource0 = {
      ...
      creator: 'António Nogueira',
      creationDate: '1564',
      copyrightDate: '1524',
      importDate: '2015-3-25',
      license: { id: 1, name: 'Creative Commons'},
      tags: [],
      notes: '',
      medium: 'oil on panel',
      physicalDimensions: '115 x 115 cm',
      ...
      sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/0/05/Antonio-nogueira_descida-da-cruz-1.jpg',
      width: 591,
      height: 680,
      mimeType: 'image/jpeg'
    }
    ...
    let mockResource1 = {
      id: 2,
      seq: 2,
      title: 'The Twelve-Year-Old Jesus Teaching in the Temple',
      description: 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.',
      creator: 'Ludovico Mazzolino',
      creationDate: '1524',
      copyrightDate: '1524',
      importDate: '2015-3-25',
      license: { id: 2, name: 'unknown'},
      tags: [],
      notes: '',
    ...
    let mockResource2 = {
      ...
      description: 'Ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.',
      creator: 'Leonardo da Vinci',
      creationDate: 'from 1495 until 1498',
      copyrightDate: '1498',
      importDate: '2015-3-25',
      license: { id: 3, name: 'Public Domain'},
      tags: [],
      notes: '',
